...
|---|---|
| [pfc-duckdb](https://github.com/ImpossibleForge/pfc-duckdb) | SQL queries on `.pfc` archives directly from DuckDB |
| [pfc-gateway](https://github.com/ImpossibleForge/pfc-gateway) | HTTP alternative for querying `.pfc` archives without DuckDB |
